...
function RecruiterJobActions({ job, onJobDeleted }: { job: Job; onJobDeleted: () => void }) {
    ...
    return (
        <>
            ...
            <DeleteConfirmationModal
                ...
                description={`Are you sure you want to delete "${job.title}"? This action cannot be undone and will affect all pending applications.`}
...
function CandidateJobActions({ job }: { job: Job }) {
    const { toast } = useToast()
            ...
            <div className="container py-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <CardContent className="p-8">
                                ...
                                {isJobOwner ? (
                                    <Alert className="mb-4">
                                        ...
                                        <AlertDescription>
                                            This is your job posting. Use the sidebar to manage applications and edit details.
                                        </AlertDescription>
                                    </Alert>
                                ) : isAuthenticated ? (
                                    user?.role.roleName === "CANDIDATE" ? (
                                        ...
                                        <Alert>
                                            <AlertCircle className="h-4 w-4" />
                                            <AlertDescription>
                                                Only candidates can apply for jobs. Switch to a candidate account to apply.
                                            </AlertDescription>
                                        </Alert>
                                    )
                                ) : (
                                    ...
                                    <TabsContent value="requirements" className="space-y-4">
                                        <div>
                                            ...
                                            <ul className="space-y-2">
                                                ...
                                                )) : <li className="text-muted-foreground">No specific skills listed.</li>}
                                            </ul>
                                        </div>
                                    </TabsContent>
                    ...
                    <div className="space-y-6">
                        ...
                        {isJobOwner && (
                            <RecruiterJobActions job={job} onJobDeleted={handleJobDeleted} />
                        )}
                        ...
                        <Card className="shadow-lg">
                            ...
                            <CardContent className="space-y-4">
                                <div className="flex items-center justify-between">
                                    ...
                                    <Badge variant={getJobTypeVariant(job.jobType)}>{job.jobType?.replace("_", " ") || "Unknown"}</Badge>
                                </div>
                                <Separator />
                                <div className="flex items-center justify-between">
                                ...
                                <CardContent className="space-y-4">
                                    <div className="text-center">
                                        <p className="text-sm text-muted-foreground mb-4">
                                            Have questions about this position? Contact the hiring team.
                                        </p>
