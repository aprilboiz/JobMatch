...
INSERT INTO jobs (id, title, job_type, salary_type, min_salary, max_salary, currency, salary_period, number_of_openings, application_deadline, status, description, location, company_id, recruiter_id, created_at, updated_at, job_category_id) VALUES 
(3, 'DevOps Engineer', 'FULL_TIME', 'RANGE', 95000, 130000, 'USD', 'ANNUAL', 2, '2024-04-05', 'OPEN', 'We are seeking a DevOps Engineer to help streamline our development and deployment processes. Experience with AWS, Docker, Kubernetes, and CI/CD pipelines is required.', 'Remote', 1, 6, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 1);
...
INSERT INTO jobs (id, title, job_type, salary_type, min_salary, max_salary, currency, salary_period, number_of_openings, application_deadline, status, description, location, company_id, recruiter_id, created_at, updated_at, job_category_id) VALUES 
(5, 'QA Automation Engineer', 'FULL_TIME', 'RANGE', 80000, 105000, 'USD', 'ANNUAL', 2, '2024-04-10', 'OPEN', 'Join our QA team to develop and maintain our automated testing frameworks. Experience with Selenium, JUnit, and continuous integration tools is required.', 'San Francisco, CA (Hybrid)', 1, 6, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 1);
...
INSERT INTO jobs (id, title, job_type, salary_type, min_salary, max_salary, currency, salary_period, number_of_openings, application_deadline, status, description, location, company_id, recruiter_id, created_at, updated_at, job_category_id) VALUES 
(9, 'Investment Banking Analyst', 'FULL_TIME', 'COMPETITIVE', NULL, NULL, 'USD', 'ANNUAL', 4, '2024-03-22', 'OPEN', 'Entry-level position for recent finance graduates. You will support senior bankers in financial modeling, market research, and deal execution.', 'New York, NY (Onsite)', 2, 7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 2);
...
INSERT INTO jobs (id, title, job_type, salary_type, min_salary, max_salary, currency, salary_period, number_of_openings, application_deadline, status, description, location, company_id, recruiter_id, created_at, updated_at, job_category_id) VALUES 
(12, 'Sustainability Consultant', 'FULL_TIME', 'RANGE', 65000, 90000, 'USD', 'ANNUAL', 3, '2024-03-25', 'OPEN', 'Work with clients to develop and implement sustainability strategies. Background in environmental science or sustainability management is required.', 'Remote', 3, 8, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 11);

INSERT INTO jobs (id, title, job_type, salary_type, min_salary, max_salary, currency, salary_period, number_of_openings, application_deadline, status, description, location, company_id, recruiter_id, created_at, updated_at, job_category_id) VALUES 
(13, 'Renewable Energy Engineer', 'FULL_TIME', 'RANGE', 80000, 110000, 'USD', 'ANNUAL', 1, '2024-04-05', 'OPEN', 'Design and implement renewable energy solutions for our clients. Experience with solar, wind, or other renewable technologies is required.', 'Portland, OR (Hybrid)', 3, 8, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 5);
...
-- MediLife Jobs
INSERT INTO jobs (id, title, job_type, salary_type, min_salary, max_salary, currency, salary_period, number_of_openings, application_deadline, status, description, location, company_id, recruiter_id, created_at, updated_at, job_category_id) VALUES 
(16, 'Biomedical Engineer', 'FULL_TIME', 'RANGE', 85000, 115000, 'USD', 'ANNUAL', 2, '2024-04-15', 'OPEN', 'Design and develop medical devices and equipment. Experience with medical technology design and regulatory requirements is necessary.', 'Boston, MA (Onsite)', 4, 9, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 4);

INSERT INTO jobs (id, title, job_type, salary_type, min_salary, max_salary, currency, salary_period, number_of_openings, application_deadline, status, description, location, company_id, recruiter_id, created_at, updated_at, job_category_id) VALUES 
(17, 'Clinical Research Coordinator', 'FULL_TIME', 'FIXED', 70000, NULL, 'USD', 'ANNUAL', 3, '2024-03-28', 'OPEN', 'Coordinate and manage clinical trials for new therapies. Experience in clinical research and knowledge of regulatory requirements is required.', 'Boston, MA (Hybrid)', 4, 9, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 4);
...
INSERT INTO jobs (id, title, job_type, salary_type, min_salary, max_salary, currency, salary_period, number_of_openings, application_deadline, status, description, location, company_id, recruiter_id, created_at, updated_at, job_category_id) VALUES 
(21, 'Supply Chain Analyst', 'FULL_TIME', 'RANGE', 65000, 85000, 'USD', 'ANNUAL', 3, '2024-04-20', 'OPEN', 'Analyze supply chain data to identify optimization opportunities. Experience with supply chain analytics and inventory management systems is required.', 'Chicago, IL (Hybrid)', 5, 10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 8);

INSERT INTO jobs (id, title, job_type, salary_type, min_salary, max_salary, currency, salary_period, number_of_openings, application_deadline, status, description, location, company_id, recruiter_id, created_at, updated_at, job_category_id) VALUES 
(22, 'Logistics Coordinator', 'FULL_TIME', 'FIXED', 55000, NULL, 'USD', 'ANNUAL', 4, '2024-03-25', 'OPEN', 'Coordinate shipping, transportation, and delivery operations. Experience with logistics software and freight operations is necessary.', 'Chicago, IL (Onsite)', 5, 10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 8);

INSERT INTO jobs (id, title, job_type, salary_type, min_salary, max_salary, currency, salary_period, number_of_openings, application_deadline, status, description, location, company_id, recruiter_id, created_at, updated_at, job_category_id) VALUES 
(23, 'Transportation Manager', 'FULL_TIME', 'RANGE', 75000, 100000, 'USD', 'ANNUAL', 1, '2024-04-05', 'OPEN', 'Oversee transportation operations and carrier relationships. Experience managing transportation networks and carrier contracts is required.', 'Chicago, IL (Hybrid)', 5, 10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 8);

INSERT INTO jobs (id, title, job_type, salary_type, min_salary, max_salary, currency, salary_period, number_of_openings, application_deadline, status, description, location, company_id, recruiter_id, created_at, updated_at, job_category_id) VALUES 
(24, 'International Trade Specialist', 'FULL_TIME', 'NEGOTIABLE', NULL, NULL, 'USD', 'ANNUAL', 2, '2024-03-30', 'OPEN', 'Manage international shipping and customs compliance. Knowledge of international trade regulations and customs procedures is required.', 'Chicago, IL (Hybrid)', 5, 10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 8);
